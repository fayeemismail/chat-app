        ...
        <div style={{ 
            ...
            <div className="max-w-lg mx-auto">
                <h1 className="text-4xl font-bold text-center mb-12 tracking-tight" style={{ color: colors.text }}>
                    <span style={{ borderBottom: `2px solid ${colors.accent}`, paddingBottom: '0.5rem' }}>Conversations</span>
                </h1>
                ...
                <div style={{ 
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <h2 className="text-xl font-medium tracking-wide" style={{ color: colors.text }}>Available Rooms</h2>
                        <button
                            style={{ 
                    ...
                    {rooms.length > 0 ? (
                        <ul style={{ borderColor: colors.border }} className="divide-y">
                            {rooms.map((room) => (
                                ...
                                >
                                    <span style={{ color: colors.text }} className="font-medium">{room?.name || "Unknown Room"}</span>
                                    <button
                                        style={{ 
                        ...
                        <div className="py-12 text-center">
                            <p style={{ color: colors.secondaryText }} className="italic">No conversations available</p>
                            <p style={{ color: colors.accent }} className="text-sm mt-2">Create a room to begin</p>
                        </div>
                    )}
                </div>
            </div>
